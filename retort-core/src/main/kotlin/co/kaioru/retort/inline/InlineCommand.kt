...
inline fun <I : CommandContext, O> command(name: String, body: ICommandBuilder<I, O>.() -> Unit): ICommandBuilder<I, O> {
    return CommandBuilder(name)
}

inline fun <I : CommandContext, O> executable(crossinline body: I.() -> O): ICommandExecutable<I, O> {
